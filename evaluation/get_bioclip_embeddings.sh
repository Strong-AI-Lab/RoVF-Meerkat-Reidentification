...
generate_name() {
    ...
    local dataset=$4
    local mask_option=$5
    echo "bioclip_${strat}_${frames}frames_${dataset}_${mask_option}"
}
...
run_embedding() {
    ...
    local output_dir="${BASE_DIR}/results/pre_trained_model/bioclip"
...
echo "BioCLIP embedding generation complete!"
