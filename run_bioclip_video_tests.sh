...
MODEL_DIR="results/hyperparameter_search/bioclip_video"
DEVICE="cuda"
GPU_DEVICE="${GPU_DEVICE:-1}"

usage() {
    cat <<'EOF'
Usage: run_bioclip_video_tests.sh [options]

Run test mode for BioCLIP video checkpoints, with and without masks.

Options:
  --model-dir DIR       Checkpoint directory. Defaults to results/hyperparameter_search/bioclip_video.
  ...
  --gpu GPU             CUDA_VISIBLE_DEVICES value. Defaults to GPU_DEVICE or 1.
