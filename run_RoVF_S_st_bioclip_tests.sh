...
usage() {
    cat <<'EOF'
Usage: run_RoVF_S_st_bioclip_tests.sh [options]

Run test mode for RoVF_S_st_bioclip checkpoints, with and without masks.

Options:
  --model-dir DIR       Checkpoint directory. Defaults to results/hyperparameter_search/RoVF_S_st_bioclip.
