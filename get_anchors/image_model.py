...
def get_anchor_pos_and_neg_dino(model, positive_list, negative_list, device, similarity_measure=None, is_ret_emb=False):
    ...
    #emb_tens = model(batch_tens.permute(0, 1, 4, 2, 3))
    ...
    dist_to_pos2 = similarity_measure(negative_embeds, positive_embeds[pos2].unsqueeze(0)).squeeze() # Shape: (num_negatives)
